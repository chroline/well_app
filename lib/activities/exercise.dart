...
class ExerciseTab extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final minutes = useState(DayCollectionStore.today.exercise);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _ExerciseForm(
              onSubmit: (_minutes) {
                DayCollectionRepository.update(exercise: _minutes);
...
class _ExerciseForm extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final ctrl = useTextEditingController(
        text: DayCollectionStore.today.exercise.toString());
