...
class MeditationTab extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final minutes = useState(DayCollectionService.I.today.meditation);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _MeditationForm(
              onSubmit: (_minutes) {
                DayCollectionService.I.update(meditation: _minutes);
...
class _MeditationForm extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final ctrl = useTextEditingController(
        text: DayCollectionService.I.today.meditation.toString());
